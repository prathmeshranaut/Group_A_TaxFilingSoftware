...
int calcualte_otbenefits(cJSON *root) {
    ...
    if (((cJSON_GetObjectItem(applicant_object, AGE)->valueint) < 64)) {
        ...
        calculation.sales_tax_benefits = (((cJSON_GetObjectItem(applicant_object, HOUSE_RENT)->valuedouble) +
                                           (cJSON_GetObjectItem(applicant_object, HOUSE_RENT_OWN_RENT)->valuedouble))) *
                                         0.2;
        ...
        calculation.calcualted_otb =
                calculation.energy_benefits + calculation.sales_tax_benefits + calculation.northern_benefits;
