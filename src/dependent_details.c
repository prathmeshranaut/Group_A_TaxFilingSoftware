...
int input_dependent_details(cJSON *root) {
    ...
    cJSON_AddItemToObject(dependent_details_object, CLAIM_CHILD_CARE_BENEFITS,
                          cJSON_CreateString(details.claim_child_care_benefits));
    cJSON_AddItemToObject(dependent_details_object, DEPENDENT_NET_INCOME,
                          cJSON_CreateNumber(details.dependent_net_income));
