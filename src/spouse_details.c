...
int input_spouse_details(cJSON *root) {
     ...
     cJSON_AddItemToObject(spouse_details_object, SIN, cJSON_CreateString(details.sin));
     cJSON_AddItemToObject(spouse_details_object, NET_INCOME, cJSON_CreateString(details.net_income));
