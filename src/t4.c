...
int input_t4_details(cJSON *root) {
    ...
    while ('y' == has_details) {
        ...
        cJSON_AddItemToObject(t4_details_object, EMPLOYER_NAME, cJSON_CreateString(t4_details.employers_name));
        cJSON_AddItemToObject(t4_details_object, PROVINCE, cJSON_CreateString(t4_details.province));
        cJSON_AddItemToObject(t4_details_object, EMPLOYMENT_INCOME, cJSON_CreateString(t4_details.employment_income));
        cJSON_AddItemToObject(t4_details_object, EMPLOYEES_CPP_CONTRIBUTION, cJSON_CreateString(t4_details.employees_cpp_contribution));
        cJSON_AddItemToObject(t4_details_object, EMPLOYEES_QPP_CONTRIBUTION, cJSON_CreateString(t4_details.employees_qpp_contribution));
        cJSON_AddItemToObject(t4_details_object, EMPLOYEES_EI_PREMIUMS, cJSON_CreateString(t4_details.employees_ei_premiums));
        cJSON_AddItemToObject(t4_details_object, RPP_CONTRIBUTIONS, cJSON_CreateString(t4_details.rpp_contributions));
        cJSON_AddItemToObject(t4_details_object, INCOME_TAX_DEDUCTED, cJSON_CreateString(t4_details.income_tax_deducted));
        cJSON_AddItemToObject(t4_details_object, EI_INSURABLE_EARNINGS, cJSON_CreateString(t4_details.ei_insurable_earnings));
        cJSON_AddItemToObject(t4_details_object, CPP_QPP_PENSIONABLE_EARNINGS, cJSON_CreateString(t4_details.cpp_qpp_pensionable_earnings));
        cJSON_AddItemToObject(t4_details_object, UNION_DUES, cJSON_CreateString(t4_details.union_dues));
        cJSON_AddItemToObject(t4_details_object, CHARITABLE_DONATIONS, cJSON_CreateString(t4_details.charitable_donations));
        cJSON_AddItemToObject(t4_details_object, RPP_DSSP_REGISTRATION_NUMBER, cJSON_CreateString(t4_details.rpp_dssp_registation_number));
        cJSON_AddItemToObject(t4_details_object, PENSION_ADJUSTMENT, cJSON_CreateString(t4_details.pension_adjustment));
        cJSON_AddItemToObject(t4_details_object, EMPLOYEES_PPIP_PREMIUMS, cJSON_CreateString(t4_details.employees_ppip_premiums));
        cJSON_AddItemToObject(t4_details_object, PPIP_INSURABLE_EARNINGS, cJSON_CreateString(t4_details.ppip_insurable_earnings));
