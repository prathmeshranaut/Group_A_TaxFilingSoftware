...
int input_ot_benefits(cJSON *root) {
    ot_benefits otb = {"", 0, "n", 0, 0, "n", "", 0, "n", 0, 0, "n", "n", "", "", 0, "n", "", 0, 0, 0, "n", "", "n",
                       "n", 0, "n"};
    char opt = 'y';
    printf("\n\t\t#######################################################################################\n");
    ...
    cJSON_AddItemToObject(otb_object, SPOUSE_SOCIAL_ASSISTANCE_RECEIVE,
                          cJSON_CreateNumber(otb.spouse_social_assistance_receive));
    cJSON_AddItemToObject(otb_object, SPOUSE_SOCIAL_ASSISTANCE_REPAY,
                          cJSON_CreateNumber(otb.spouse_social_assistance_repay));
    ...
    cJSON_AddItemToObject(otb_object, HOUSE_RENT_LONG_TERM_CARE_TYPE,
                          cJSON_CreateString(otb.house_r_long_term_care_type));
    ...
    cJSON_AddItemToObject(otb_object, HOUSE_RENT_OWN_LONG_TERM_CARE_TYPE,
                          cJSON_CreateString(otb.house_ro_long_term_care_type));
    ...
    cJSON_AddItemToObject(otb_object, FIRST_NATIONS_RESERVE_COST,
                          cJSON_CreateNumber(otb.first_nations_reserve_energy_cost));
